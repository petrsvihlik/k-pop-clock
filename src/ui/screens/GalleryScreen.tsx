...
const CARD =
  "background:#fff7f0;border:4px solid #2a1a4a;border-radius:22px;box-shadow:0 6px 0 #120a2e;" +
  "padding:14px 10px 10px 10px;width:150px;display:flex;flex-direction:column;align-items:center;gap:6px";
 ...
 * (The on-stage mascot is Derpy, so it needs no card of its own.)
 */
